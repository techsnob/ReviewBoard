...
//	@RequestPart("photo") MultipartFile file, @ModelAttribute ("user") User user
	...
	@ResponseBody
	public String getUserDetails(@RequestParam String username) throws UnsupportedEncodingException{
